const texts = {
    ...
    skills: {
        title: "Skills",
        skills:"Skills",
        skillsTechs: "Tecnologíes",
        skillsTech: {
            python: "Web development, data analysis, artificial intelligence, and scientific computing",
            php: "Dynamic web development",
            ruby: "Web development",
            csharp: "Develop applications and games",
            javascript: "Interactive web development. An essential part of web development alongside HTML and CSS",
            node: "JavaScript runtime environment, development of scalable network applications",
            sql: "Query language for relational databases",
            mongo: "Document-oriented NoSQL database. Managing large amounts of data",
            linux: "Open-source Unix operating system. Known for its security and flexibility",
            git: "Distributed version control system. Enables collaborative development",
            docker: "Deployment of applications within lightweight and portable containers."
        },
        content: [
            {
                ...
                texts: [
                    ...
                    "Development of interactive dashboards, Data Visualization",
            ...
            },
            {
                ...
                texts: [
                    "Development of Desktop Applications in a Linux environment",
        ...
        projects: [
            {
                ...
                description: [
                    "Document notarization, Study on blockchain technologies, Development of smart contracts in Solidity; to test different types of contracts",
            ...
            },
            {
                ...
                description: [
                    "Creation of forms, Drag & Drop interface for Widgets, Automated deployment of this module for various clients. The project was successfully completed and is in production.",
            ...
            },
            {
                ...
                description: [
                    "Creation of AI models to apply SAGRILAFT regulations and identify risks or non-compliance. Support for the Data Science department, Database management.",
            ...
            },
            {
                ...
                description: [
                    "Development of a Web 2.0 Application, considering the experience and state of the company at the time of project execution.",
            ...
            },
            {
                ...
                description: [
                    "Development of scripts to scrape different sources to detect possible risks in insurance policies.",
