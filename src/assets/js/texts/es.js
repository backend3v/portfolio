const texts = {
    presentation:{
        ...
        about:"Con mas de 7 años de experiencia en varias startups entre ellas Stradata, Symplfica (Top 5 de empresas mas innovadoras en latinoamerica por FAST COMPANY 2023 ) , mangosoft y tulpep. Desarrollando software para diversas industrias, cuento con la experiencia adquirida y la capacidad para trabajar de manera autonoma",
    ...
    jobs:{
        ...
        jobs:[
            ...
            },
            {
                ...
                description:[
                    "Desarrollo de software, Industria de Seguros, ETL de datos, Scrapping web y optimizacion de consultas SQL",
                    "Python(Scrapy, Requests, Pandas), Azure CosmoDb, Bash, Linux, Docker"
                ],
            },
            {
                name:"Biznaga Media",
